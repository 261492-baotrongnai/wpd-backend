      ...
      const response = await this.gemini.models.generateContent({
        ...
        contents: [
          createUserContent([
            ...
            'หากมีหลายเมนูในภาพ ให้ตอบมาแบบบอกชื่อให้ครบตามจำนวนของเมนูที่เห็นในภาพ เช่น หากในรูปมี 3 อย่าง ให้ตอบ name: /[ส้มตำ,ไก่ย่าง,ข้าวเหนียว/] หากมี 1 อย่างให้ตอบ name: /[ส้มตำ/] (ทุกสมาชิกใน array name รวมกันไม่เกิน 40 characters)`, )',
